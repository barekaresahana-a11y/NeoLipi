...
# -------------------------
# Devanagari = 1, Others = 0
all_imgs = tamil_imgs + brahmi_imgs + dev_imgs

all_labels = (
    [0]*len(tamil_imgs) +      # Tamil → 0
    [0]*len(brahmi_imgs) +     # Brahmi → 0
    [1]*len(dev_imgs)          # Devanagari → 1
)
...
print("Training Devanagari vs All...")
model.fit(
...
# SAVE
# -------------------------
model.save("dev_vs_all.h5")

print("✅ Devanagari model done")