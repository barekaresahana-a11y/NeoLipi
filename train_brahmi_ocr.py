...
DATASET_PATH = r"D:\NeoLipi_Dataset\brahmi\train"
...
with open("brahmi_labels.txt", "w") as f:
    for label in class_names:
        f.write(label + "\n")

print("Brahmi labels saved successfully!")
...
model.save("brahmi_ocr.keras")
model.save("brahmi_ocr.h5")
...
print("\n" + "="*60)
print("BRAHMI OCR TRAINING COMPLETED")
print("="*60)
