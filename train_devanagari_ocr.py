...
DATASET_PATH = r"D:\NeoLipi_Dataset\devanagari\DevanagariHandwrittenCharacterDataset\Train"
...
with open("devanagari_labels.txt", "w") as f:
    for label in class_names:
        f.write(label + "\n")

print("Devanagari labels saved successfully!")
...
model.save("devanagari_ocr.keras")
model.save("devanagari_ocr.h5")
...
print("\n" + "="*60)
print("DEVANAGARI OCR TRAINING COMPLETED")
print("="*60)
...
print("\nGenerated Files:")
print("✓ devanagari_ocr.keras")
print("✓ devanagari_ocr.h5")
print("✓ devanagari_labels.txt")
